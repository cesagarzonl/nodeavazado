...
test.beforeEach(async () => {
  ...
  AgentStub = {
    hasMany: sandbox.spy() // model find One stub

  };
  AgentStub.findOne = sandbox.stub();
  AgentStub.findOne.withArgs(uuidArgs).returns(Promise.resolve(agentFixtures.byUuid(uuid))); // model findby id stub

  AgentStub.findById = sandbox.stub();
  AgentStub.findById.withArgs(id).returns(Promise.resolve(agentFixtures.byId(id))); // model update stub
...
test.serial('Setup', t => {
  ...
  t.true(_rec5._expr(_rec5._capt(_rec5._capt(_rec5._capt(MetricStub, "arguments/0/object/object").belongsTo, "arguments/0/object").called, "arguments/0"), {
...
test.serial('Agent#createORUpdate - existe', async t => {
  ...
  t.true(_rec6._expr(_rec6._capt(_rec6._capt(_rec6._capt(AgentStub, "arguments/0/object/object").findOne, "arguments/0/object").called, "arguments/0"), {
    content: "t.true(AgentStub.findOne.called, 'find one should be callled on model')",
    filepath: "tests/agent-test.js",
    line: 71,
    async: true,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"MemberExpression\",\"object\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"AgentStub\",\"range\":[7,16]},\"property\":{\"type\":\"Identifier\",\"name\":\"findOne\",\"range\":[17,24]},\"computed\":false,\"range\":[7,24]},\"property\":{\"type\":\"Identifier\",\"name\":\"called\",\"range\":[25,31]},\"computed\":false,\"range\":[7,31]},{\"type\":\"StringLiteral\",\"value\":\"find one should be callled on model\",\"range\":[33,70]}],\"range\":[0,71]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"AgentStub\",\"range\":[7,16]},{\"type\":{\"label\":\".\"},\"range\":[16,17]},{\"type\":{\"label\":\"name\"},\"value\":\"findOne\",\"range\":[17,24]},{\"type\":{\"label\":\".\"},\"range\":[24,25]},{\"type\":{\"label\":\"name\"},\"value\":\"called\",\"range\":[25,31]},{\"type\":{\"label\":\",\"},\"range\":[31,32]},{\"type\":{\"label\":\"string\"},\"value\":\"find one should be callled on model\",\"range\":[33,70]},{\"type\":{\"label\":\")\"},\"range\":[70,71]}]",
    visitorKeys: _powerAssertVisitorKeys
  }), 'find one should be callled on model');
  t.true(_rec7._expr(_rec7._capt(_rec7._capt(_rec7._capt(AgentStub, "arguments/0/object/object").findOne, "arguments/0/object").calledTwice, "arguments/0"), {
    content: "t.true(AgentStub.findOne.calledTwice, 'finOne shoud be called twice')",
    filepath: "tests/agent-test.js",
    line: 72,
    async: true,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"MemberExpression\",\"object\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"AgentStub\",\"range\":[7,16]},\"property\":{\"type\":\"Identifier\",\"name\":\"findOne\",\"range\":[17,24]},\"computed\":false,\"range\":[7,24]},\"property\":{\"type\":\"Identifier\",\"name\":\"calledTwice\",\"range\":[25,36]},\"computed\":false,\"range\":[7,36]},{\"type\":\"StringLiteral\",\"value\":\"finOne shoud be called twice\",\"range\":[38,68]}],\"range\":[0,69]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"AgentStub\",\"range\":[7,16]},{\"type\":{\"label\":\".\"},\"range\":[16,17]},{\"type\":{\"label\":\"name\"},\"value\":\"findOne\",\"range\":[17,24]},{\"type\":{\"label\":\".\"},\"range\":[24,25]},{\"type\":{\"label\":\"name\"},\"value\":\"calledTwice\",\"range\":[25,36]},{\"type\":{\"label\":\",\"},\"range\":[36,37]},{\"type\":{\"label\":\"string\"},\"value\":\"finOne shoud be called twice\",\"range\":[38,68]},{\"type\":{\"label\":\")\"},\"range\":[68,69]}]",
    visitorKeys: _powerAssertVisitorKeys
  }), 'finOne shoud be called twice');
  t.true(_rec8._expr(_rec8._capt(_rec8._capt(_rec8._capt(AgentStub, "arguments/0/object/object").update, "arguments/0/object").calledOnce, "arguments/0"), {
    content: "t.true(AgentStub.update.calledOnce, 'finOne shoud be called twice')",
    filepath: "tests/agent-test.js",
    line: 73,
    async: true,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"MemberExpression\",\"object\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"AgentStub\",\"range\":[7,16]},\"property\":{\"type\":\"Identifier\",\"name\":\"update\",\"range\":[17,23]},\"computed\":false,\"range\":[7,23]},\"property\":{\"type\":\"Identifier\",\"name\":\"calledOnce\",\"range\":[24,34]},\"computed\":false,\"range\":[7,34]},{\"type\":\"StringLiteral\",\"value\":\"finOne shoud be called twice\",\"range\":[36,66]}],\"range\":[0,67]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"AgentStub\",\"range\":[7,16]},{\"type\":{\"label\":\".\"},\"range\":[16,17]},{\"type\":{\"label\":\"name\"},\"value\":\"update\",\"range\":[17,23]},{\"type\":{\"label\":\".\"},\"range\":[23,24]},{\"type\":{\"label\":\"name\"},\"value\":\"calledOnce\",\"range\":[24,34]},{\"type\":{\"label\":\",\"},\"range\":[34,35]},{\"type\":{\"label\":\"string\"},\"value\":\"finOne shoud be called twice\",\"range\":[36,66]},{\"type\":{\"label\":\")\"},\"range\":[66,67]}]",
    visitorKeys: _powerAssertVisitorKeys
  }), 'finOne shoud be called twice');
...
test('Metric', t => {
  ...
  t.truthy(_rec9._expr(_rec9._capt(_rec9._capt(db, "arguments/0/object").Metric, "arguments/0"), {
    content: "t.truthy(db.Metric, 'Metric Exist')",
    filepath: "tests/agent-test.js",
    line: 77,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"truthy\",\"range\":[2,8]},\"computed\":false,\"range\":[0,8]},\"arguments\":[{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"db\",\"range\":[9,11]},\"property\":{\"type\":\"Identifier\",\"name\":\"Metric\",\"range\":[12,18]},\"computed\":false,\"range\":[9,18]},{\"type\":\"StringLiteral\",\"value\":\"Metric Exist\",\"range\":[20,34]}],\"range\":[0,35]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"name\"},\"value\":\"truthy\",\"range\":[2,8]},{\"type\":{\"label\":\"(\"},\"range\":[8,9]},{\"type\":{\"label\":\"name\"},\"value\":\"db\",\"range\":[9,11]},{\"type\":{\"label\":\".\"},\"range\":[11,12]},{\"type\":{\"label\":\"name\"},\"value\":\"Metric\",\"range\":[12,18]},{\"type\":{\"label\":\",\"},\"range\":[18,19]},{\"type\":{\"label\":\"string\"},\"value\":\"Metric Exist\",\"range\":[20,34]},{\"type\":{\"label\":\")\"},\"range\":[34,35]}]",
    visitorKeys: _powerAssertVisitorKeys
  }), 'Metric Exist');
});
//# sourceMappingURL=/home/andrea/Escritorio/pruebasx/avanza_nodejs/platziverse/platziverse-db/node_modules/.cache/ava/2d3bb4849792aa50da0264007e7f9594.js.map